...
const Layout = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className="flex flex-col">
          ...
          <ul className="flex flex-col gap-8">
            ...
            <li>
              ...
              >
                ...
                >
                  <path
                    d="M8.00004 9.82155C6.58004 9.82155 5.42004 8.66821 5.42004 7.24155C5.42004 5.81488 6.58004 4.66821 8.00004 4.66821C9.42004 4.66821 10.58 5.82155 10.58 7.24821C10.58 8.67488 9.42004 9.82155 8.00004 9.82155ZM8.00004 5.66821C7.13338 5.66821 6.42004 6.37488 6.42004 7.24821C6.42004 8.12155 7.12671 8.82821 8.00004 8.82821C8.87338 8.82821 9.58004 8.12155 9.58004 7.24821C9.58004 6.37488 8.86671 5.66821 8.00004 5.66821Z"
                    fill="currentColor"
                  />
                  <path
                    d="M8 15.5483C7.01333 15.5483 6.01999 15.1749 5.24666 14.4349C3.28 12.5416 1.10666 9.52159 1.92666 5.92825C2.66666 2.66825 5.51333 1.20825 8 1.20825C8 1.20825 8 1.20825 8.00666 1.20825C10.4933 1.20825 13.34 2.66825 14.08 5.93492C14.8933 9.52825 12.72 12.5416 10.7533 14.4349C9.97999 15.1749 8.98666 15.5483 8 15.5483ZM8 2.20825C6.06 2.20825 3.56666 3.24159 2.90666 6.14825C2.18666 9.28825 4.16 11.9949 5.94666 13.7083C7.1 14.8216 8.90666 14.8216 10.06 13.7083C11.84 11.9949 13.8133 9.28825 13.1067 6.14825C12.44 3.24159 9.93999 2.20825 8 2.20825Z"
                    fill="currentColor"
                  />
                </svg>
                Address
      ...
      {/* bg-[#F4F3EC] */}
      <div className="lg:ml-[25%] bg-white min-h-screen flex flex-col">
        <AdminTopBanner />
        <div className="p-3 md:py-5 md:px-[2rem] mt-1 lg:mt-[4.8rem] bg-inherit space-y-10">
          {children}
        </div>
      </div>
    </div>
