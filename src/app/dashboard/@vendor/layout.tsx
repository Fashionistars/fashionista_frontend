          ...
          <ul className="flex flex-col gap-10">
            ...
            <li>
              ...
              >
                ...
                >
                  <path
                    d="M4.41235 10.7719V6.69336H18.7554V10.7719C18.7554 13.8076 18.7554 15.3255 17.8219 16.2685C16.8883 17.2116 15.3858 17.2116 12.3807 17.2116H10.7871C7.78199 17.2116 6.27946 17.2116 5.34591 16.2685C4.41235 15.3255 4.41235 13.8076 4.41235 10.7719Z"
                    stroke="currentColor"
                    strokeWidth="1.43431"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M4.41235 6.69298L5.10192 5.2219C5.63673 4.08099 5.90412 3.51054 6.44612 3.18935C6.98813 2.86816 7.68338 2.86816 9.07385 2.86816H14.0939C15.4844 2.86816 16.1796 2.86816 16.7217 3.18935C17.2636 3.51054 17.5311 4.08099 18.0658 5.2219L18.7554 6.69298"
                    stroke="currentColor"
                    strokeWidth="1.43431"
                    strokeLinecap="round"
                  />
                  <path
                    d="M10.1497 9.56152H13.0183"
                    stroke="currentColor"
                    strokeWidth="1.43431"
                    strokeLinecap="round"
                  />
                  <path
                    d="M11.584 19.6016V21.9921M11.584 19.6016H6.80299M11.584 19.6016H16.365M6.80299 19.6016H4.41248C3.09224 19.6016 2.02197 20.6718 2.02197 21.9921M6.80299 19.6016V21.9921M16.365 19.6016H18.7555C20.0758 19.6016 21.1461 20.6718 21.1461 21.9921M16.365 19.6016V21.9921"
                    stroke="currentColor"
                    strokeWidth="1.43431"
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <ul>
                <li
                  className={`text-center pl-8 items-center pt-5 ${
                    !pathname.includes("/dashboard/products")
                      ? "hidden"
                      : "inline-flex"
                  }`}
                >
                  <Link
                    className={`text-xl leading-[27px] font-medium font-satoshi  flex items-center gap-4 ${
                      pathname.includes("/dashboard/products/catelog")
                        ? "text-[#fda600]"
                        : "text-[#bbb]"
                    }`}
                    href="/dashboard/products/catelog"
                  >
                    <svg
                      width="24"
                      height="24"
