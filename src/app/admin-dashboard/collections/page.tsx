  ...
  const products = [
    {
      ...
      title: "Your Style with the Latest Fashion Trends",
      price: "$1200",
      date: "02.07.2024",
      status: "active",
    },
    {
      ...
      title: "We offer amazing discounts on first order.",
      price: "$1200",
      date: "02.07.2024",
      status: "active",
    },
    {
      id: 3,
      image: "/man2_asset.svg",
      title: "Get your exact measurement without stress",
      price: "$1200",
      date: "02.07.2024",
      status: "active",
    },
  ...
  const productList = products.map((product) => {
    return (
      <div key={product.id} className="lg:w-[24%] md:w-[30%] w-[48%]">
        ...
        <div className="space-y-1 flex flex-col justify-between h-32">
    ...
    <div className="space-y-10 bg-inherit">
      <div className="flex flex-col md:flex-row md:items-center justify-between space-y-3">
        ...
        <div className="flex items-center gap-4 ">
          ...
          <Link
            href="/admin-dashboard/collections/new-collection"
