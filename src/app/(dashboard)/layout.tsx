          ...
          <ul className="flex flex-col gap-10">
            ...
            <li>
              <Link
                href="/orders"
                className={`text-xl leading-[27px] font-medium font-satoshi  flex items-center gap-4 ${
                  pathname == "/orders" ? "text-[#fda600]" : "text-[#bbb]"
                }`}
              >
                <svg
                  width="24"
              ...
              <ul>
                <li
                  className={`text-center pl-8 items-center pt-5 ${
                    !pathname.includes("/products") ? "hidden" : "inline-flex"
                  }`}
                >
                  <Link
                    className={`text-xl leading-[27px] font-medium font-satoshi  flex items-center gap-4 ${
                      pathname.includes("/catelog")
                        ? "text-[#fda600]"
                        : "text-[#bbb]"
                    }`}
                    href="products/catelog"
                  >
                    <svg
                      width="24"
                      height="24"
            ...
            <li>
              <Link
                href="/analytics"
                className={`text-xl leading-[27px] font-medium font-satoshi  flex items-center gap-4 ${
                  pathname == "/analytics" ? "text-[#fda600]" : "text-[#bbb]"
                }`}
              >
                <svg
                  width="24"
            ...
            <li>
              <Link
                href="/payments"
                className={`text-xl leading-[27px] font-medium font-satoshi  flex items-center gap-4 ${
                  pathname == "/payments" ? "text-[#fda600]" : "text-[#bbb]"
                }`}
              >
                <svg
                  width="24"
            ...
            <li>
              <Link
                href="/customers"
                className={`text-xl leading-[27px] font-medium font-satoshi  flex items-center gap-4 ${
                  pathname == "/customers" ? "text-[#fda600]" : "text-[#bbb]"
                }`}
              >
                <svg
                  width="24"
            ...
            <li>
              <Link
                href="/wallet"
                className={`text-xl leading-[27px] font-medium font-satoshi  flex items-center gap-4 ${
                  pathname == "/wallet" ? "text-[#fda600]" : "text-[#bbb]"
                }`}
              >
                <svg
                  width="24"
