...
export const FormSchema = z.object({
    ...
    title: z.string({required_error: 'This field is required'}).min(3, "Title is required"),
    description: z.string({required_error: 'This field is required'}).min(1, "Description is required"),
    sales_prices: z.string({required_error: 'This field is required'}).min(1, "Sales price is required"),
    regular_prices: z.string().min(1, "Regular price is required"),
    shipping_amount: z.string().min(1, "Shipping amount is required"),
    stock_qty: z.string().min(1, "Stock quantity is required"),
    tag:z.string().min(1, "Tag is required"),
    total_price: z.string().min(1, "Total price is required"),
