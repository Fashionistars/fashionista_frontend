...
export const metadata: Metadata = {
  title: "Sign In",
  description: "Sign in to your FASHIONISTAR AI account to access exclusive collections and AI-powered size recommendations.",
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-card p-8 animate-fade-in">
          ...
          <Link
            ...
            id="google-auth-btn"
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-border rounded-lg text-sm font-medium hover:bg-muted/50 transition-all"
          >
