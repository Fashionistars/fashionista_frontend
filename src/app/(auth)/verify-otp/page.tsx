      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-card p-8 animate-fade-in">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold font-satoshi text-foreground">Verify Your Identity</h1>
            <p className="text-sm text-muted-foreground mt-1">Enter the 6-digit code to continue</p>
          </div>
